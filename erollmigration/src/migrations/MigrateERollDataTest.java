...
public class MigrateERollDataTest {
...
//        String postgresPassword = "khadc@@@75";
        ...
        try {
            ...
            String selectQuery = " SELECT EPIC_ID, NULL AS PROCESS_TYPE, EPIC_NUMBER, APPLICANT_FIRST_NAME, APPLICANT_FIRST_NAME_L1, APPLICANT_LAST_NAME, APPLICANT_LAST_NAME_L1, "
                    ...
                    + " DOB, NULL AS HOUSE_NO_OLD, 'N' AS STATUS_TYPE, RELATION_L_NAME, RLN_L_NM_V1, IS_ACTIVE, 0 AS REVISION_NO, NULL AS NOTIONAL_HNO, HOUSE_NUMBER_L1, 'N' AS  MOVED, 'Y' AS ISADCVOTER, PHOTO "
                    + " FROM EROLL_DATA WHERE 1 = 1 AND ASSEMBLY_CONSTITUENCY_NUMBER=31";
            ...
            while (resultSet.next()) {
                ...
                if (resultSet.getString("APPLICANT_LAST_NAME") == null) {
                    statementPG.setNull(6, java.sql.Types.NULL);
                } else {
                    statementPG.setString(6, resultSet.getString("APPLICANT_LAST_NAME"));
                }

                if (resultSet.getString("APPLICANT_LAST_NAME_L1") == null) {
                    statementPG.setNull(7, java.sql.Types.NULL);
                } else {
                ...
                if(resultSet.getString("DOB")==null){
                    statementPG.setNull(18, java.sql.Types.NULL);
                } else {
                    statementPG.setString(18, resultSet.getString("DOB"));
                }
                ...
                if(resultSet.getString("ISADCVOTER")==null){
                    statementPG.setNull(28, java.sql.Types.VARCHAR);
                } else {
                    statementPG.setString(28, resultSet.getString("ISADCVOTER"));
                }
                ...
                if (resultSet.getString("PHOTO") == null) {
                    statementPG.setNull(29, java.sql.Types.VARCHAR);
                } else {
                    statementPG.setBytes(29, resultSet.getBytes("PHOTO"));
                }
                ...
                System.out.println(resultSet.getInt("ASSEMBLY_CONSTITUENCY_NUMBER") + "-" + resultSet.getInt("PART_NUMBER") + "-" + resultSet.getInt("PART_SERIAL_NUMBER") + "-" + resultSet.getString("EPIC_NUMBER"));
                statementPG.execute();
